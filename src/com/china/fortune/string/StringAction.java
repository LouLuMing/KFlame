...
//    }
    ...
    public static void main(String[] args) {
        Log.log(StringAction.max(null, "1232"));
        Log.log(StringAction.max("1232", null));
        Log.log(StringAction.max("132", "1232"));

        String sText = "message";
        Log.log(sText + ":" + StringAction.getSigner(sText));
        sText = "r";
        Log.log(sText + ":" + StringAction.getSigner(sText));
        sText = "gpmsg";
        Log.log(sText + ":" + StringAction.getSigner(sText));
        ...
        String[] lsKey = StringAction.split(sSelect, ',');
