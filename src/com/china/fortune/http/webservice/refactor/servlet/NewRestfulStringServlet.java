...
public abstract class NewRestfulStringServlet extends NewRestfulBaseServlet<String[]> {
	protected CheckKeys ksKey = new CheckKeys();
	protected CheckKeys ksUnKey = new CheckKeys();

	abstract protected void onParamMiss(JSONObject json, String sKey);
	...
	protected void clone(NewRestfulStringServlet rs) {
		bGZip = rs.bGZip;
